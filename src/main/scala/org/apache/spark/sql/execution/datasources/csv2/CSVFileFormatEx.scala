 ...
 */
class CSVFileFormatEx extends TextBasedFileFormat with DataSourceRegister {

  override def shortName(): String = "csv2"

  override def toString: String = "CSV2"

  override def hashCode(): Int = getClass.hashCode()

  override def equals(other: Any): Boolean = other.isInstanceOf[CSVFileFormatEx]
